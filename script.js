...
// // // BASE 10: 0-1 1/10 = 0.1. 3/10 = 3.3333333
// // // Binary base 2: 0-1
// // console.log(0.1 + 0.2);
...
// console.log(128341902390123089789023423479234790n);
// console.log(BigInt(473240349342342342342342343434n + 1237891239012903n));

// const huge = 123912309123120n;
// const num = 23;
...
// console.log(accounts.movementsDates[0]);
...
// setTimeout
const ingredients = ['olives', 'spinachап'];
...
setInterval(function () {
  const now = new Date();
  const clock = Intl.DateTimeFormat('ru-RU', {
    hour: 'numeric',
    minute: 'numeric',
    second: 'numeric',
  }).format(now);
